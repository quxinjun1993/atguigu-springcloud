...
public class PaymentService {
    ...
    public String paymentInfo_Timeout_handle(Integer id) {
        return "线程池：" + Thread.currentThread().getName() + "  8001_paymentInfo_Timeout,id:" + id + "\t" + "o(╥﹏╥)o";
    }
    ...
    @HystrixCommand(fallbackMethod = "payment_circuitBreaker_fallback",commandProperties = {
            ...
            @HystrixProperty(name = "circuitBreaker.errorThresholdPercentage",value = "60")//失败率达到多少调招
    })
